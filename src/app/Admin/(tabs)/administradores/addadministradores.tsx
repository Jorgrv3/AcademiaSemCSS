...
export default function AddAluno(){
    ...
    async function cadastrarAdmin(id: string){
        try {
            await CTDatabase.cadastrarAdmin(id)
        } catch (error) {
            console.log
        }
        Alert.alert("Admin efetivado com sucesso!")
    }
            ...
            <View style={aulasStyle.bigView}>
                ...
                <View style={{}}>
                    <FlatList 
                        ...
                        <Usuarios 
                            data={item} 
                            onSelect={()=> cadastrarAdmin(String(item.id))}
                        />}
                    />
                </View>
            </View>
